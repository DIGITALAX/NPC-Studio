...
import { VerMediosProps } from "../types/common.types";
...
const VerMedios: FunctionComponent<VerMediosProps> = ({
  ...
  return (
    <div className="inset-0 justify-center fixed z-100 bg-opacity-50 backdrop-blur-sm overflow-y-hidden grid grid-flow-col auto-cols-auto w-full h-auto">
      <div
