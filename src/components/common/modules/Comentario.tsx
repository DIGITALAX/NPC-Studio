        ...
        <div className="absolute w-full h-fit flex justify-between items-center flex-row gap-3 bottom-2 left-0 px-2">
            ...
            {[
              {
                ...
                apagado:
                  Number(comentarPublicar[indice]?.imagenes?.length) +
                    Number(comentarPublicar[indice]?.videos?.length) +
                    Number(comentarPublicar[indice]?.gifs?.length) ==
                  4,
              },
              {
          ...
          <div className="relative w-fit h-fit flex items-center justify-end flex">
            <div
              ...
              onClick={() =>
                !publicacionCargando && manejarPublicar(indice, comentarioId)
              }
            >
              {publicacionCargando ? (
                <div
